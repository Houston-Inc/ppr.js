...
!function(e,t){"function"==typeof define&&define.amd?define("ppr.library.event_bus_prototype",["jquery","lodash"],t):"object"==typeof exports?module.exports=t(require("jquery"),require("lodash")):e.ppr.library.event_bus_prototype=t(e.$,e._)}(this,function(e,t){"use strict";var s=function(t){this.eventList={},this.messageIndex={},this.configList=e.extend({},{debug:!1},t)};return s.prototype={getEvents:function(){return this.eventList},getEventsByMessage:function(e){return"undefined"!=typeof this.eventList[e]?this.eventList[e]:{}},log:function(e,t,s){if(this.configList.debug!==!0)return!1;Array.prototype.slice.call(arguments).splice(2,2);switch(e){case"subscribe":break;case"unsubscribe":break;case"publish":}},subscribe:function(e,s,i){"undefined"==typeof this.eventList[s]&&(this.eventList[s]={});var n=t.uniqueId(s);return this.log("subscribe",s,n,e),this.eventList[s][n]={scope:e,callback:i},this.messageIndex[n]=s,n},unsubscribe:function(e){"string"==typeof e&&(e=[e]);var s=this;return t.each(e,function(i){if("undefined"==typeof s.messageIndex[i])return!1;var n=s.messageIndex[i];return s.log("unsubscribe",n,e),"undefined"!=typeof s.eventList[n][i]&&(delete s.eventList[n][i],void(0===t.keys(s.eventList[n]).length&&delete s.eventList[n]))}),!0},publish:function(e,s){var i=Array.prototype.slice.call(arguments);return i.shift(),this.log("publish",e,i,t.map(this.eventList[e],"scope")),"undefined"!=typeof this.eventList[e]&&void t.each(this.eventList[e],function(e){e.callback.apply(e.scope,i)})}},s});
...
!function(t,e){"function"==typeof define&&define.amd?define("ppr.library.utils.loader",["lodash"],e):"object"==typeof exports?module.exports=e(require("lodash")):t.ppr.library.utils.loader=e(t._)}(this,function(t){"use strict";return{hasAMDSupport:function(){return"function"==typeof define&&define.amd},hasCommonSupport:function(){return"object"==typeof exports},load:function(e,o,n){if("function"!=typeof n)throw new Error("Callback has to present");"object"!=typeof e&&(e=[e]);var r=[];return this.hasAMDSupport()?(o.custom===!0&&(e=t.map(e,function(t){if(t.lastIndexOf(".")>t.lastIndexOf("/")){t=t.split(".");var e=t.pop();t=t.join(".")+"/"+e}return t})),require(e,n)):this.hasCommonSupport()?(t.each(e,function(e){e=e.split("."),e.shift(),e=t.map(e,t.camelCase),e.unshift("../.."),e=e.join("/").toLowerCase().trim(),r.push(require(e))}),n.apply(null,r)):(t.each(e,function(e){r.push(t.get(window,e))}),n.apply(null,r))}}});
...
!function(t,e){"function"==typeof define&&define.amd?define("ppr.library.utils.storage",[],e):"object"==typeof exports?module.exports=e():t.ppr.library.utils.storage=e()}(this,function(){"use strict";return{isSupported:function(){return"undefined"!=typeof window.localStorage},set:function(t,e){if(!this.isSupported())return null;if("object"==typeof e)try{e=JSON.stringify(e)}catch(r){}window.localStorage.setItem(t,e)},get:function(t){if(!this.isSupported())return null;var e=window.localStorage.getItem(t);try{e=JSON.parse(e)}catch(r){}return e}}});
...
!function(t,i){"function"==typeof define&&define.amd?define("ppr.library.utils.window",["ppr.config","lodash"],i):"object"==typeof exports?module.exports=i(require("../../ppr.config"),require("lodash")):t.ppr.library.utils.window=i(t.ppr.config,t._)}(this,function(t,i){"use strict";return{breakpoints:null,isBreakpoint:function(i){return this.breakpoints||(this.breakpoints=t.get("window.breakpoints",{})),"undefined"!=typeof this.breakpoints[i]},isMobile:function(){var n=this,r=!1;return i.each(t.get("window.mobile_breakpoints",[]),function(t){r||(r=n.matchBreakpoint(t))}),r},matchBreakpoint:function(t){if(!this.isBreakpoint(t))return!1;if("function"!=typeof window.matchMedia)return!1;var n=this.breakpoints[t],r=i.replace(n,/[<>]/,"").trim();return i.startsWith(n,"<")?window.matchMedia("(max-width: "+r+"px)").matches:!!i.startsWith(n,">")&&window.matchMedia("(min-width: "+r+"px)").matches},transformations:function(t){return{"-webkit-transform":t,"-moz-transform":t,"-ms-transform":t,"-o-transform":t,transform:t}},whichTransitionEvent:function(){var t,i=document.createElement("fakeelement"),n={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"};for(t in n)if(void 0!==i.style[t])return n[t]}}});
!function(t,i){"function"==typeof define&&define.amd?define("ppr.translation",["ppr.config","ppr.library.utils.string","lodash"],i):"object"==typeof exports?module.exports=i(require("./ppr.config"),require("./library/utils/string"),require("lodash")):t.ppr.translation=i(t.ppr.config,t.ppr.library.utils.string,t._)}(this,function(t,i,e){"use strict";var n;return n={isInitialized:!1,language:void 0,translationList:void 0,initialize:function(){this.language=t.get("language","en"),this.translationList=t.get("translations",{})},getAll:function(){return this.isInitialized||this.initialize(),this.translationList},getLanguage:function(t){return"undefined"!=typeof t?t:this.language},getPrefixedKey:function(t,i){return t+"."+i},translate:function(t,n,r){this.isInitialized||this.initialize();var a=e.result(this.translationList,this.getPrefixedKey(this.getLanguage(r),t),t);return"undefined"!=typeof n&&(a=i.replaceVariablesWithParameters(a,n)),a},translateFromSource:function(t,i,e){var n=this.getLanguage(e),r=this.getPrefixedKey(t,n);return i.hasOwnProperty(r)?i[r]:null}},{getAll:function(){return n.getAll()},translate:function(t,i,e){return n.translate(t,i,e)},translateFromSource:function(t,i,e){return n.translateFromSource(t,i,e)}}});
!function(t,e){"function"==typeof define&&define.amd?define("ppr.component.base_prototype",["ppr.library.utils.object"],e):"object"==typeof exports?module.exports=e(require("../library/utils/object")):t.ppr.component.base_prototype=e(t.ppr.library.utils.object)}(this,function(t){"use strict";return{children:void 0,eventBus:null,data:{},href:null,id:null,name:null,node:null,page:null,parent:void 0,messages:{},isBuilt:!1,cacheData:{},cacheSubscribers:[],afterBuild:function(){this.eventBus.publish("component_build_finished",this.id),this.isBuilt=!0},build:function(){},getChildren:function(){var t=this;if("undefined"==typeof this.children){var e=[];_.each(this.node.find("[data-component]"),function(n){var i=$(n).attr("data-component-id"),s=t.page.getComponent(i);s.getParent().id===t.id&&e.push(i)}),this.children=e}var n=[];return _.each(this.children,function(e){n.push(t.page.getComponent(e))}),n},getParent:function(){if("undefined"!=typeof this.parent)return this.page.getComponent(this.parent);var t=this.node.parents("[data-component]:first"),e=null;return t.length&&(e=t.attr("data-component-id")),this.parent=e,this.page.getComponent(this.parent)},getRequiredModules:function(){return[]},initialize:function(e){this.id=e.id,this.node=e.node,this.name=e.name,this.eventBus=e.eventBus,this.page=e.page,this.cacheData=this.data,this.node.attr({"data-component":this.name,"data-component-id":this.id}),this.node.attr("data-component-href")&&(this.href=this.node.attr("data-component-href")),this.node.attr("data-component-data")&&(this.data=$.extend({},this.data,t.parseJSON(this.node.attr("data-component-data"))))},isBuildable:function(){return $.Deferred().resolve().promise()},reset:function(){this.data=$.extend(!0,{},this.cacheData),this.href=null,this.isBuilt=!1,this.eventBus.unsubscribe(this.cacheSubscribers)},setModuleMessages:function(t){this.messages=t},subscribe:function(){var t=Array.prototype.slice.call(arguments);t[1]=this.id+"_"+t[1];var e=this.eventBus.subscribe.apply(this.eventBus,t);return this.cacheSubscribers.push(e),e},publish:function(){var t=Array.prototype.slice.call(arguments);return t[0]=this.id+"_"+t[0],this.eventBus.publish.apply(this.eventBus,t)}}});
!function(e,t){"function"==typeof define&&define.amd?define("ppr.component.reloadable_prototype",["ppr.component.base_prototype","jquery"],t):"object"==typeof exports?module.exports=t(require("./baseprototype"),require("jquery")):e.ppr.component.reloadable_prototype=t(e.ppr.component.base_prototype,e.$)}(this,function(e,t){"use strict";return t.extend(!0,{},e,{global_reload:!0,componentLoaderWrapper:null,afterBuild:function(){this.componentLoaderWrapper=this.node.find(".component-loader__wrapper"),this.subscribe(this,"reload",this.reload),this.subscribe(this,"reload_started",this.onReloadStarted),this.subscribe(this,"reload_ready",this.onReloadReady),this.global_reload&&this.eventBus.subscribe(this,"reload_components",this.reload),this.eventBus.publish("component_build_finished",this.id),this.isBuilt=!0},onReloadStarted:function(){this.componentLoaderWrapper.length&&this.componentLoaderWrapper.addClass("component-loader__wrapper--active")},onReloadReady:function(e){e=e.filter("*:not(text):not(comment)"),this.reset(),this.node.replaceWith(e),e.attr("data-component-id",this.id),this.eventBus.publish("build_component",e)},reload:function(){var e=this;this.publish("reload_started"),t.get(this.href).done(function(o){e.publish("reload_ready",t(o))})}})});
!function(i,e){"function"==typeof define&&define.amd?define("ppr.module.base_prototype",[],e):"object"==typeof exports?module.exports=e():i.ppr.module.base_prototype=e()}(this,function(){"use strict";return{isInitialized:!1,configList:{},eventBus:void 0,messages:{},build:function(){},initialize:function(i,e){return!this.isInitialized&&(this.eventBus=e,this.configList=$.extend({},this.configList,i),this.isInitialized=!0,void this.build())},getMessages:function(){return this.messages}}});
!function(e,t){"function"==typeof define&&define.amd?define("ppr.page.base_prototype",["ppr.config","ppr.library.utils.object","ppr.library.utils.loader","ppr.library.event_bus_prototype","jquery","lodash"],t):"object"==typeof exports?module.exports=t(require("../ppr.config"),require("../library/utils/object"),require("../library/utils/loader"),require("../library/eventbusprototype"),require("jquery"),require("lodash")):e.ppr.page.base_prototype=t(e.ppr.config,e.ppr.library.utils.object,e.ppr.library.utils.loader,e.ppr.library.event_bus_prototype,e.$,e._)}(this,function(e,t,n,i,o,r){"use strict";return{eventBus:new i(e.get("event_bus",{})),name:null,node:null,components:{},data:null,cacheComponentReady:[],afterBuild:function(){this.setDefaultSubscribers(),this.buildComponents(),this.buildUIExtensions()},build:function(){return!0},buildComponent:function(e){var t,i=this,s=e.attr("data-component").trim(),a=r.snakeCase(s),u={},p={};s.length>0?(t="ppr.component."+a,p.custom=!0):e.attr("data-component-href")?(t="ppr.component.reloadable_prototype",s="reloadable_prototype"):(t="ppr.component.base_prototype",s="base_prototype"),e.attr("data-component-id")?u.id=e.attr("data-component-id"):u.id=r.uniqueId("Component_"),u.name=s,u.node=e,u.eventBus=this.eventBus,u.page=this,n.load(t,p,function(t){var s=new function(){return o.extend(!0,{},t)};i.components[u.id]=s,s.initialize(u);var a=s.getRequiredModules(),p=r.map(a,function(e){return"ppr.module."+e});n.load(p,{custom:!0},function(){var t=Array.prototype.slice.call(arguments),n={};r.each(t,function(e,t){e.initialize({},i.eventBus),n[a[t]]=e.getMessages()}),s.setModuleMessages(n),s.isBuildable().then(function(t){return s.build(t)===!1?(delete i.components[u.id],void e.remove()):void s.afterBuild()})})})},buildComponents:function(){var e=this;this.node.find("[data-component]").each(function(t,n){e.eventBus.publish("build_component",o(n))})},buildUIExtensions:function(){n.load(e.get("ui.builders",[]),{custom:!0},function(){var e=Array.prototype.slice.call(arguments);r.each(e,function(e){e.initialize()})})},getComponent:function(e){return"undefined"!=typeof this.components[e]?this.components[e]:null},initialize:function(e){this.name=e.name,this.node=e.node,this.data={},this.node.attr("data-page-data")&&(this.data=o.extend({},this.data,t.parseJSON(this.node.attr("data-page-data"))))},onComponentBuildFinished:function(e){this.cacheComponentReady.push(e),this.cacheComponentReady.length===r.keys(this.components).length&&this.eventBus.publish("page_build_finished")},setDefaultSubscribers:function(){this.eventBus.subscribe(this,"build_component",this.buildComponent),this.eventBus.subscribe(this,"component_build_finished",this.onComponentBuildFinished)}}});
