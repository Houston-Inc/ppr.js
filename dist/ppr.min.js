...
!function(o,t){"function"==typeof define&&define.amd?define("ppr.library.utils.loader",["lodash"],t):"object"==typeof exports?module.exports=t(require("lodash")):o.ppr.library.utils.loader=t(o._)}(this,function(o){"use strict";return{hasAMDSupport:function(){return"function"==typeof define&&define.amd},hasCommonSupport:function(){return"object"==typeof exports},load:function(t,e,n){var r=this;if("function"!=typeof n)throw new Error("Callback has to present");"object"!=typeof t&&(t=[t]);var i=[];return this.hasAMDSupport()?(e.custom===!0&&(t=o.map(t,function(o){if(o.lastIndexOf(".")>o.lastIndexOf("/")){o=o.split(".");var t=o.pop();o=o.join(".")+"/"+t}return o})),require(t,n)):this.hasCommonSupport()?(this.loadBulk(),o.each(t,function(t){t=t.split("."),t.shift(),t=o.map(t,o.camelCase),i.push(o.result(r.commonModules,t.join(".").toLowerCase().trim()))}),n.apply(null,i)):(o.each(t,function(t){i.push(o.get(window,t))}),n.apply(null,i))},loadBulk:function(){if(this.hasCommonSupport()&&this.bulkLoaded!==!0){var o=require("bulk-require");this.commonModules=o(__dirname+"/../../",["**/*.js"]),this.bulkLoaded=!0}}}});
