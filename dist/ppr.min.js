...
!function(e,t){if("function"==typeof define&&define.amd)define("ppr.library.eventbusprototype",["module","exports","lodash","ppr.config"],t);else if("undefined"!=typeof exports)t(module,exports,require("lodash"),require("ppr.config"));else{var n={exports:{}};t(n,n.exports,e._,e.pprConfig),e.pprLibraryEventbusprototype=n.exports}}(this,function(e,t,n,i){"use strict";function s(e){return e&&e.__esModule?e:{"default":e}}function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var u=s(n),a=s(i),o=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),f=function(){function e(){r(this,e),this.eventList={},this.messageIndex={}}return o(e,[{key:"getEvents",value:function(){return this.eventList}},{key:"getEventsByMessage",value:function(e){return"undefined"!=typeof this.eventList[e]?this.eventList[e]:{}}},{key:"subscribe",value:function(t,n,i,s){"undefined"==typeof this.eventList[n]&&(this.eventList[n]={});var r=u["default"].uniqueId(n);return e.log("subscribe",n,r,t),this.eventList[n][r]={scope:t,callback:i,name:s||r},this.messageIndex[r]=n,r}},{key:"unsubscribe",value:function(t){var n=this,i=t;return"string"==typeof i&&(i=[i]),u["default"].each(i,function(t){if("undefined"!=typeof n.messageIndex[t]){var s=n.messageIndex[t];e.log("unsubscribe",s,i),"undefined"!=typeof n.eventList[s][t]&&(delete n.eventList[s][t],0===u["default"].keys(n.eventList[s]).length&&delete n.eventList[s])}}),!0}},{key:"publish",value:function(e){if("undefined"==typeof this.eventList[e])return!1;for(var t=arguments.length,n=Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];return this.publishTo.apply(this,[u["default"].map(this.eventList[e],"name"),e].concat(n))}},{key:"publishTo",value:function(t,n){for(var i=arguments.length,s=Array(i>2?i-2:0),r=2;r<i;r++)s[r-2]=arguments[r];var a=t;return"undefined"!=typeof this.eventList[n]&&("string"==typeof a&&(a=[a]),a=u["default"].filter(this.eventList[n],function(e){return u["default"].indexOf(a,e.name)>-1}),e.log("publish",n,s,u["default"].map(a,"scope")),u["default"].each(a,function(e){e.callback.apply(e.scope,s)}),!0)}}],[{key:"log",value:function(e,t){if(a["default"].get("event_bus.debug",!1)===!0){for(var n=arguments.length,i=Array(n>2?n-2:0),s=2;s<n;s++)i[s-2]=arguments[s];switch(e){case"subscribe":break;case"unsubscribe":break;case"publish":}}}}]),e}();t["default"]=f,e.exports=t["default"]});
...
!function(e,t){if("function"==typeof define&&define.amd)define("ppr.page.baseprototype",["module","exports","jquery","lodash","ppr.config","ppr.library.utils.object","ppr.library.utils.loader","ppr.library.eventbusprototype"],t);else if("undefined"!=typeof exports)t(module,exports,require("jquery"),require("lodash"),require("ppr.config"),require("ppr.library.utils.object"),require("ppr.library.utils.loader"),require("ppr.library.eventbusprototype"));else{var n={exports:{}};t(n,n.exports,e.$,e._,e.pprConfig,e.pprLibraryUtilsObject,e.pprLibraryUtilsLoader,e.pprLibraryEventbusprototype),e.pprPageBaseprototype=n.exports}}(this,function(e,t,n,i,o,s,r,u){"use strict";function a(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var p=a(n),d=a(i),l=a(o),c=a(s),f=a(r),h=a(u);t["default"]={eventBus:new h["default"],name:null,node:null,components:{},data:null,cacheComponentReady:[],createPage:function(e){return Object.assign({},this,e)},afterBuild:function(){this.setDefaultSubscribers(),this.buildComponents(this.node),this.buildUIExtensions()},build:function(){return!0},buildComponent:function(e){var t=this,n=void 0,i=e.attr("data-component").trim(),o=d["default"].replace(d["default"].snakeCase(i),"_","-"),s={},r={};return i.length>0?(n="ppr.component."+o,r.custom=!0):e.attr("data-component-href")?(n="ppr.component.reloadableprototype",i="reloadable_prototype"):(n="ppr.component.baseprototype",i="base_prototype"),e.attr("data-component-id")?s.id=e.attr("data-component-id"):s.id=d["default"].uniqueId("Component_"),("undefined"==typeof this.components[s.id]||!this.components[s.id].isBuilt)&&(s.name=i,s.node=e,s.eventBus=this.eventBus,s.page=this,f["default"].load(n,r,function(n){if("undefined"!=typeof n){var i=n.createComponent({});t.components[s.id]=i,i.initialize(s);var o=i.getRequiredModules(),r=d["default"].map(o,function(e){return"ppr.module."+e});f["default"].load(r,{custom:!0},function(){for(var n=arguments.length,r=Array(n),u=0;u<n;u++)r[u]=arguments[u];var a={};d["default"].each(r,function(e,n){e.initialize({},t.eventBus),a[o[n]]=e.getMessages()}),i.setModuleMessages(a),i.isBuildable().then(function(n){return i.build(n)===!1?(delete t.components[s.id],void e.remove()):void i.afterBuild()})})}}),!0)},buildComponents:function(e){var t=this;e.find("[data-component]").each(function(e,n){return t.eventBus.publish("build_component",(0,p["default"])(n))})},buildUIExtensions:function(){f["default"].load(l["default"].get("ui.builders",[]),{custom:!0},function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];d["default"].each(t,function(e){e.initialize()})})},getComponent:function(e){return"undefined"!=typeof this.components[e]?this.components[e]:null},initialize:function(e){return this.name=e.name,this.node=e.node,this.data={},this.node.attr("data-page-data")&&(this.data=Object.assign({},this.data,c["default"].parseJSON(this.node.attr("data-page-data")))),!0},onComponentBuildFinished:function(e){this.cacheComponentReady.push(e),this.cacheComponentReady.length===d["default"].keys(this.components).length&&this.eventBus.publish("page_build_finished")},removeComponent:function(e){var t=this,n=e;"string"==typeof e&&(n=[e]),d["default"].each(n,function(e){var n=t.components[e];"undefined"!=typeof n&&(n.reset(),n.node.remove(),delete t.components[e])})},setDefaultSubscribers:function(){this.eventBus.subscribe(this,"remove_component",this.removeComponent),this.eventBus.subscribe(this,"build_components",this.buildComponents),this.eventBus.subscribe(this,"build_component",this.buildComponent),this.eventBus.subscribe(this,"build_extensions",this.buildUIExtensions),this.eventBus.subscribe(this,"component_build_finished",this.onComponentBuildFinished)}},e.exports=t["default"]});
...
!function(e,t){if("function"==typeof define&&define.amd)define("ppr.component.baseprototype",["module","exports","jquery","lodash","ppr.library.utils.object"],t);else if("undefined"!=typeof exports)t(module,exports,require("jquery"),require("lodash"),require("ppr.library.utils.object"));else{var n={exports:{}};t(n,n.exports,e.$,e._,e.pprLibraryUtilsObject),e.pprComponentBaseprototype=n.exports}}(this,function(e,t,n,i,a){"use strict";function s(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var r=s(n),o=s(i),d=s(a);t["default"]={children:void 0,eventBus:null,data:{},href:null,id:null,name:null,node:null,page:null,parent:void 0,messages:{},isBuilt:!1,cacheData:{},cacheSubscribers:[],createComponent:function(e){return Object.assign({},this,e)},afterBuild:function(){this.eventBus.publish("component_build_finished",this.id),this.isBuilt=!0},build:function(){return!0},getChildren:function(){var e=this;"undefined"==typeof this.children&&!function(){var t=[];o["default"].each(e.node.find("[data-component]"),function(n){var i=(0,r["default"])(n).attr("data-component-id"),a=e.page.getComponent(i);a.getParent().id===e.id&&t.push(i)}),e.children=t}();var t=[];return o["default"].each(this.children,function(n){t.push(e.page.getComponent(n))}),t},getParent:function(){if("undefined"!=typeof this.parent)return this.page.getComponent(this.parent);var e=this.node.parents("[data-component]:first"),t=null;return e.length&&(t=e.attr("data-component-id")),this.parent=t,this.page.getComponent(this.parent)},getRequiredModules:function(){return[]},initialize:function(e){this.id=e.id,this.node=e.node,this.name=e.name,this.eventBus=e.eventBus,this.page=e.page,this.cacheData=this.data,this.node.attr({"data-component":this.name,"data-component-id":this.id}),this.node.attr("data-component-href")&&(this.href=this.node.attr("data-component-href")),this.node.attr("data-component-data")&&(this.data=Object.assign({},this.data,d["default"].parseJSON(this.node.attr("data-component-data"))))},isBuildable:function(){return r["default"].Deferred().resolve().promise()},reset:function(){this.data=r["default"].extend(!0,{},this.cacheData),this.href=null,this.isBuilt=!1,this.eventBus.unsubscribe(this.cacheSubscribers)},setModuleMessages:function(e){this.messages=e}},e.exports=t["default"]});
!function(e,t){if("function"==typeof define&&define.amd)define("ppr.component.reloadableprototype",["module","exports","jquery","ppr.component.baseprototype"],t);else if("undefined"!=typeof exports)t(module,exports,require("jquery"),require("ppr.component.baseprototype"));else{var o={exports:{}};t(o,o.exports,e.$,e.pprComponentBaseprototype),e.pprComponentReloadableprototype=o.exports}}(this,function(e,t,o,r){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var s=i(o),n=i(r);t["default"]=n["default"].createComponent({componentLoaderWrapper:null,afterBuild:function(){this.componentLoaderWrapper=this.node.find(".component-loader__wrapper");var e=[this.eventBus.subscribe(this,"reload",this.reload,this.id),this.eventBus.subscribe(this,"reload_started",this.onReloadStarted,this.id),this.eventBus.subscribe(this,"reload_ready",this.onReloadReady,this.id),this.eventBus.subscribe(this,"reload_components",this.reload)];this.cacheSubscribers=this.cacheSubscribers.concat(e),this.eventBus.publish("component_build_finished",this.id),this.isBuilt=!0},onReloadStarted:function(){this.componentLoaderWrapper.length&&this.componentLoaderWrapper.addClass("component-loader__wrapper--active")},onReloadReady:function(e){var t=e.filter("*:not(text):not(comment)");this.reset(),this.node.replaceWith(t),t.attr("data-component-id",this.id),this.eventBus.publish("build_component",t)},reload:function(){var e=this;this.eventBus.publishTo(this.id,"reload_started"),s["default"].get(this.href).done(function(t){e.eventBus.publishTo(e.id,"reload_ready",(0,s["default"])(t))})}}),e.exports=t["default"]});
...
!function(e,t){if("function"==typeof define&&define.amd)define("ppr.module.baseprototype",["module","exports"],t);else if("undefined"!=typeof exports)t(module,exports);else{var i={exports:{}};t(i,i.exports),e.pprModuleBaseprototype=i.exports}}(this,function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t["default"]={isInitialized:!1,configList:{},eventBus:void 0,messages:{},build:function(){return!0},createModule:function(e){return Object.assign({},this,e)},initialize:function(e,t){return!this.isInitialized&&(this.eventBus=t,this.configList=Object.assign({},this.configList,e),this.isInitialized=!0,this.build(),!0)},getMessages:function(){return this.messages}},e.exports=t["default"]});
...
!function(e,t){if("function"==typeof define&&define.amd)define("ppr.ui.builderprototype",["module","exports","ppr.library.utils.loader"],t);else if("undefined"!=typeof exports)t(module,exports,require("ppr.library.utils.loader"));else{var r={exports:{}};t(r,r.exports,e.pprLibraryUtilsLoader),e.pprUiBuilderprototype=r.exports}}(this,function(e,t,r){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var u=i(r);t["default"]={initialize:function(){var e=this;return!!this.shouldBuild()&&(u["default"].load(this.getDependencies(),{custom:!0},function(){e.build.apply(e,arguments)}),!0)},shouldBuild:function(){return!0},getDependencies:function(){return[]}},e.exports=t["default"]});
...
!function(e,t){if("function"==typeof define&&define.amd)define("ppr",["module","exports","jquery","lodash","ppr.library.utils.loader","ppr.config"],t);else if("undefined"!=typeof exports)t(module,exports,require("jquery"),require("lodash"),require("ppr.library.utils.loader"),require("ppr.config"));else{var r={exports:{}};t(r,r.exports,e.$,e._,e.pprLibraryUtilsLoader,e.pprConfig),e.ppr=r.exports}}(this,function(e,t,r,a,i,o){"use strict";function n(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var u=n(r),f=n(a),d=n(i),p=n(o);t["default"]={build:function(){this.buildPage()},buildPage:function(){var e=this,t=(0,u["default"])("body"),r={},a={},i="ppr.page.baseprototype",o=t.attr("data-page");"undefined"!=typeof o&&o.length>0?(i="ppr.page."+f["default"].replace(f["default"].snakeCase(o.trim()),"_","-"),a.custom=!0):o="base_prototype",r.name=o,r.node=t,d["default"].load(i,a,function(t){var a=t.createPage({});a.initialize(r),e.page_instance=a,a.build(),a.afterBuild()})},loadConfig:function(e){var t=this,r=u["default"].Deferred();return u["default"].ajax({dataType:"json",url:e,success:function(e){t.setConfig(e),r.resolve(e)},fail:function(){r.reject("Load configuration failed")}}),r.promise()},setConfig:function(e){f["default"].each(e,function(e,t){p["default"].set(t,e)})}},e.exports=t["default"]});