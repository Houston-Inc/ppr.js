...
!function(t,e){"function"==typeof define&&define.amd?define("ppr.library.utils.string",["lodash"],e):"object"==typeof exports?module.exports=e(require("lodash")):t.ppr.library.utils.string=e(t.vendor._)}(this,function(t){"use strict";return{generateHash:function(t){var e,r,a,n=0;if(0===t.length)return n;for(e=0,a=t.length;e<a;e++)r=t.charCodeAt(e),n=(n<<5)-n+r,n|=0;return n},getAsPlainText:function(t){return $("<p>").html(t).text()},linkifyHashTags:function(t,e){var r,a;return a={twitter:"https://twitter.com/hashtag/",facebook:"https://www.facebook.com/hashtag/",instagram:"https://www.instagram.com/explore/tags/"},e=e.toLowerCase(),"undefined"==typeof a[e]?t:(r=a[e],t=t.replace(/[#]+[A-Za-z0-9-_äöåÄÖÅ]+/g,function(t){var e,a;return e=t.replace("#",""),a=$("<a>").attr("class","hashtag").attr("href",r+e).attr("target","_blank").text(t),a[0].outerHTML}))},replaceVariablesWithParameters:function(e,r){return t.each(r,function(t,r){e=e.replace(":"+r,t)}),e}}});
...
!function(e,r){"function"==typeof define&&define.amd?define("ppr",["jquery","lodash","ppr.library.utils.loader","ppr.config"],r):"object"==typeof exports?module.exports=r(require("jquery"),require("lodash"),require("./library/utils/loader"),require("./ppr.config")):e.ppr=e.vendor._.assign(e.ppr,r(e.vendor.$,e.vendor._,e.ppr.library.utils.loader,e.ppr.config))}(this,function(e,r,i,n){"use strict";return{build:function(){this.buildPage()},buildPage:function(){var n=this,t="ppr.page.base_prototype",o=e("body"),a=o.attr("data-page"),u={},p={};"undefined"!=typeof a&&a.length>0?(t="ppr.page."+r.snakeCase(a.trim()),p.custom=!0):a="base_prototype",u.name=a,u.node=o,i.load(t,p,function(r){var i=new function(){return e.extend(!0,{},r)};i.initialize(u),n.page_instance=i,i.build(),i.afterBuild()})},loadConfig:function(r){var i=this,n=e.Deferred();return e.ajax({dataType:"json",url:r,success:function(e){i.setConfig(e),n.resolve(e)},fail:function(){n.reject("Load configuration failed")}}),n.promise()},setConfig:function(e){r.each(e,function(e,r){n.set(r,e)})}}});