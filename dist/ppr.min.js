...
!function(e,t){"function"==typeof define&&define.amd?define("ppr.library.utils.loader",["lodash"],t):"object"==typeof exports?module.exports=t(require("lodash")):e.ppr.library.utils.loader=t(e._)}(this,function(e){"use strict";return{hasAMDSupport:function(){return"function"==typeof define&&define.amd},hasCommonSupport:function(){return"object"==typeof exports},load:function(t,o,r){if("function"!=typeof r)throw new Error("Callback has to present");"object"!=typeof t&&(t=[t]);var n=[];if(this.hasAMDSupport())return o.custom===!0&&(t=e.map(t,function(e){if(e.lastIndexOf(".")>e.lastIndexOf("/")){e=e.split(".");var t=e.pop();e=e.join(".")+"/"+t}return e})),require(t,r);if(this.hasCommonSupport()){var i=require("bulk-require");return i("../../",["component/baseprototype.js"]),e.each(t,function(t){t=t.split("."),t.shift(),t=e.map(t,e.camelCase),t.unshift("../.."),t=t.join("/").toLowerCase().trim(),n.push(require(t))}),r.apply(null,n)}return e.each(t,function(t){n.push(e.get(window,t))}),r.apply(null,n)}}});
