...
!function(e,t){if("function"==typeof define&&define.amd)define("ppr.page.baseprototype",["module","exports","jquery","lodash","ppr.config","ppr.library.utils.object","ppr.library.utils.loader","ppr.library.eventbusprototype"],t);else if("undefined"!=typeof exports)t(module,exports,require("jquery"),require("lodash"),require("ppr.config"),require("ppr.library.utils.object"),require("ppr.library.utils.loader"),require("ppr.library.eventbusprototype"));else{var n={exports:{}};t(n,n.exports,e.$,e._,e.pprConfig,e.pprLibraryUtilsObject,e.pprLibraryUtilsLoader,e.pprLibraryEventbusprototype),e.pprPageBaseprototype=n.exports}}(this,function(e,t,n,o,i,r,u,s){"use strict";function a(e){return e&&e.__esModule?e:{"default":e}}function p(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var l=a(n),d=a(o),c=a(i),f=a(r),h=a(u),b=a(s),m=function(){function e(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,n,o){return n&&e(t.prototype,n),o&&e(t,o),t}}(),v=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};p(this,e),this.node=t,this.name=n.name||null,this.data=null,this.eventBus=new b["default"],this.components={},this.cacheComponentReady=[],this.node.attr("data-page-data")&&(this.data=Object.assign({},this.data,f["default"].parseJSON(this.node.attr("data-page-data"))))}return m(e,[{key:"afterBuild",value:function(){this.setDefaultSubscribers(),this.buildComponents(this.node),this.buildUIExtensions()}},{key:"build",value:function(){return!0}},{key:"buildComponent",value:function(e){var t=this,n=void 0,o=e.attr("data-component").trim(),i=d["default"].replace(d["default"].snakeCase(o),"_","-"),r={},u={};return o.length>0?(n="ppr.component."+i,u.custom=!0):e.attr("data-component-href")?(n="ppr.component.reloadableprototype",o="reloadable_prototype"):(n="ppr.component.baseprototype",o="base_prototype"),e.attr("data-component-id")?r.id=e.attr("data-component-id"):r.id=d["default"].uniqueId("Component_"),("undefined"==typeof this.components[r.id]||!this.components[r.id].isBuilt)&&(r.name=o,r.eventBus=this.eventBus,r.page=this,h["default"].load(n,u,function(n){if("undefined"!=typeof n){var o=new n(e,r);t.components[r.id]=o;var i=o.getRequiredModules(),u=d["default"].map(i,function(e){return"ppr.module."+e});h["default"].load(u,{custom:!0},function(){for(var n=arguments.length,u=Array(n),s=0;s<n;s++)u[s]=arguments[s];var a={};d["default"].each(u,function(e,n){e.initialize({},t.eventBus),a[i[n]]=e.getMessages()}),o.setModuleMessages(a),o.isBuildable().then(function(n){return o.build(n)===!1?(delete t.components[r.id],void e.remove()):void o.afterBuild()})})}}),!0)}},{key:"buildComponents",value:function(e){var t=this;e.find("[data-component]").each(function(e,n){return t.eventBus.publish("build_component",(0,l["default"])(n))})}},{key:"buildUIExtensions",value:function(){h["default"].load(c["default"].get("ui.builders",[]),{custom:!0},function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];d["default"].each(t,function(e){e.initialize()})})}},{key:"getComponent",value:function(e){return"undefined"!=typeof this.components[e]?this.components[e]:null}},{key:"onComponentBuildFinished",value:function(e){this.cacheComponentReady.push(e),this.cacheComponentReady.length===d["default"].keys(this.components).length&&this.eventBus.publish("page_build_finished")}},{key:"removeComponent",value:function(e){var t=this,n=e;"string"==typeof e&&(n=[e]),d["default"].each(n,function(e){var n=t.components[e];"undefined"!=typeof n&&(n.reset(),n.node.remove(),delete t.components[e])})}},{key:"setDefaultSubscribers",value:function(){this.eventBus.subscribe(this,"remove_component",this.removeComponent),this.eventBus.subscribe(this,"build_components",this.buildComponents),this.eventBus.subscribe(this,"build_component",this.buildComponent),this.eventBus.subscribe(this,"build_extensions",this.buildUIExtensions),this.eventBus.subscribe(this,"component_build_finished",this.onComponentBuildFinished)}}],[{key:"createPage",value:function(e){return Object.assign({},this,e)}}]),e}();t["default"]=v,e.exports=t["default"]});
